...
You'll need to decide if you want to return a request or perform the request and return the result.
...
This now allows us to perform a test request and look at the response:
