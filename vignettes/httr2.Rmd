...
-   The HTTP **method**, which is a verb that tells the server what you want to do.
    ...
    Other verbs include POST, to send data, PUT, to update an existing resource, and DELETE, to delete resources.
...
A number of `req_` functions don't directly affect how the request is sent but affect the process of submitting the request and handling the response.
