...
You need to look after an refresh token a little more carefully than an access token.
...
-   The access token only lasts a couple hours and needs to be submitted this with every request.
