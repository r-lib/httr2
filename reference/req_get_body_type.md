...
- raw: created by
  [`req_body_raw()`](https://httr2.r-lib.org/reference/req_body.md) with
  a raw vector.
...
- json: created by
  [`req_body_json()`](https://httr2.r-lib.org/reference/req_body.md)/[`req_body_json_modify()`](https://httr2.r-lib.org/reference/req_body.md).
...
- obfuscated:
  ...
  [obfuscated](https://httr2.r-lib.org/reference/obfuscate.md) values.
