...
- Only consults the cache set by
  [`req_cache()`](https://httr2.r-lib.org/reference/req_cache.md) when
...
[response](https://httr2.r-lib.org/reference/response.md) if successful
or rejects on the same errors thrown by
[`req_perform()`](https://httr2.r-lib.org/reference/req_perform.md).
