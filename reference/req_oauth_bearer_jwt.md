...
- claim:
  ...
  [`jwt_claim()`](https://httr2.r-lib.org/reference/jwt_claim.md) will
  automatically fill in the dynamic components. If other components need
  to vary, you can instead provide a zero-argument callback function
  which should call
...
- signature:
  ...
  [`jwt_encode_sig()`](https://httr2.r-lib.org/reference/jwt_claim.md).
...
OAuth; `oauth_flow_bearer_jwt()` returns an
