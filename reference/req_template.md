...
[`request()`](https://httr2.r-lib.org/reference/request.md). This means
that you'll generally want to avoid multiple `req_template()` calls on
the same request.
...
#> <httr2_request>
#> GET http://127.0.0.1:41151/bytes/100
#> Body: empty
...
#> <httr2_request>
#> GET http://127.0.0.1:41151/bytes/200
#> Body: empty
...
#> <httr2_request>
#> GET http://127.0.0.1:41151/test/set/id/a3fWa
#> Body: empty
```
