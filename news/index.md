...
- httr2 now requires rlang \>= 1.3.0, which changes the hash used to
  ...
  [`req_cache()`](https://httr2.r-lib.org/reference/req_cache.md) and
  on-disk OAuth token caches (e.g. from
...
- [`last_response_json()`](https://httr2.r-lib.org/reference/last_response.md)
...
- [`oauth_client()`](https://httr2.r-lib.org/reference/oauth_client.md)
  ...
  and the client carries all of the server’s endpoints, so the OAuth
  flows pick them up automatically instead of threading them into each
  call ([\#846](https://github.com/r-lib/httr2/issues/846)).
...
- [`req_auth_aws_v4()`](https://httr2.r-lib.org/reference/req_auth_aws_v4.md)
...
- [`req_body_form()`](https://httr2.r-lib.org/reference/req_body.md) now
  creates a valid empty request body when no parameters are provided
  ([@arcresu](https://github.com/arcresu),
  [\#836](https://github.com/r-lib/httr2/issues/836)).
- [`req_body_form()`](https://httr2.r-lib.org/reference/req_body.md) and
  [`req_url_query()`](https://httr2.r-lib.org/reference/req_url.md) no
  longer error with “C stack usage is too close to the limit” when given
  very long string values
  ([\#805](https://github.com/r-lib/httr2/issues/805)).
- [`req_cache()`](https://httr2.r-lib.org/reference/req_cache.md) no
...
- [`req_error()`](https://httr2.r-lib.org/reference/req_error.md) is now
  applied to responses retrieved from the cache, so a custom `is_error`
  callback is respected on cache hits
...
- [`req_oauth_device()`](https://httr2.r-lib.org/reference/req_oauth_device.md)
  ...
  matching
  [`oauth_flow_device()`](https://httr2.r-lib.org/reference/req_oauth_device.md)
  ([\#834](https://github.com/r-lib/httr2/issues/834)).
- [`req_throttle()`](https://httr2.r-lib.org/reference/req_throttle.md)
...
- [`resp_link_url()`](https://httr2.r-lib.org/reference/resp_link_url.md)
  and
  [`iterate_with_link_url()`](https://httr2.r-lib.org/reference/iterate_with_offset.md)
  no longer error on `Link` headers that contain a trailing comma
  ([\#804](https://github.com/r-lib/httr2/issues/804)).
- [`resp_stream_aws()`](https://httr2.r-lib.org/reference/resp_stream_raw.md)
...
- [`resp_stream_lines()`](https://httr2.r-lib.org/reference/resp_stream_raw.md)
...
- [`resp_stream_lines()`](https://httr2.r-lib.org/reference/resp_stream_raw.md)
  ...
  deprecated.
- [`resp_stream_lines()`](https://httr2.r-lib.org/reference/resp_stream_raw.md),
  [`resp_stream_sse()`](https://httr2.r-lib.org/reference/resp_stream_raw.md),
  and
  [`resp_stream_aws()`](https://httr2.r-lib.org/reference/resp_stream_raw.md)
...
- New
  [`resps_ok()`](https://httr2.r-lib.org/reference/resps_successes.md)
  returns a logical vector indicating which requests were successful
  ([\#807](https://github.com/r-lib/httr2/issues/807)).
- [`url_modify()`](https://httr2.r-lib.org/reference/url_modify.md)
...
- [`req_perform_stream()`](https://httr2.r-lib.org/reference/req_perform_stream.md)
...
- URL construction is now powered by
  ...
  [`req_url_path()`](https://httr2.r-lib.org/reference/req_url.md) now
  can only affect the path component of the URL, not the query params or
  fragment.

- New
  [`last_request_json()`](https://httr2.r-lib.org/reference/last_response.md)
  and
  [`last_response_json()`](https://httr2.r-lib.org/reference/last_response.md)
...
- New
  [`req_get_url()`](https://httr2.r-lib.org/reference/req_get_url.md),
  [`req_get_method()`](https://httr2.r-lib.org/reference/req_get_method.md),
  [`req_get_headers()`](https://httr2.r-lib.org/reference/req_get_headers.md),
  `req_body_get_type()`, and
  [`req_get_body()`](https://httr2.r-lib.org/reference/req_get_body_type.md)
  allow you to introspect a request object
  ([\#718](https://github.com/r-lib/httr2/issues/718)).

- New
  [`resp_timing()`](https://httr2.r-lib.org/reference/resp_timing.md)
...
- [`req_perform_iterative()`](https://httr2.r-lib.org/reference/req_perform_iterative.md),
  [`req_perform_sequential()`](https://httr2.r-lib.org/reference/req_perform_sequential.md),
  [`req_perform_parallel()`](https://httr2.r-lib.org/reference/req_perform_parallel.md),
  [`req_perform_promise()`](https://httr2.r-lib.org/reference/req_perform_promise.md),
  and
  [`req_perform_connection()`](https://httr2.r-lib.org/reference/req_perform_connection.md)
  now support mocking
...
- [`req_body_json()`](https://httr2.r-lib.org/reference/req_body.md) and
  [`req_body_form()`](https://httr2.r-lib.org/reference/req_body.md)
...
- [`req_error()`](https://httr2.r-lib.org/reference/req_error.md) errors
  with long bodies are now correctly wrapped
...
- [`req_url_query()`](https://httr2.r-lib.org/reference/req_url.md) now
  re-calculates n lengths when using `.multi = "explode"` to avoid
...
- [`req_headers()`](https://httr2.r-lib.org/reference/req_headers.md)
...
- [`req_perform_parallel()`](https://httr2.r-lib.org/reference/req_perform_parallel.md)
  ...
  versions of
  [`req_throttle()`](https://httr2.r-lib.org/reference/req_throttle.md)
  and [`req_retry()`](https://httr2.r-lib.org/reference/req_retry.md),
...
- [`local_verbosity()`](https://httr2.r-lib.org/reference/with_verbosity.md)
...
- [`req_headers_redacted()`](https://httr2.r-lib.org/reference/req_headers.md)
...
- [`req_user_agent()`](https://httr2.r-lib.org/reference/req_user_agent.md)
...
- [`is_online()`](https://httr2.r-lib.org/reference/is_online.md) wraps
...
- [`req_retry()`](https://httr2.r-lib.org/reference/req_retry.md)
...
- [`req_url_relative()`](https://httr2.r-lib.org/reference/req_url.md)
  navigates to a relative URL
  ([\#449](https://github.com/r-lib/httr2/issues/449)).

- [`resp_request()`](https://httr2.r-lib.org/reference/resp_request.md)
...
- [`resp_stream_is_complete()`](https://httr2.r-lib.org/reference/resp_stream_raw.md)
  checks if data remains in the stream
  ([\#559](https://github.com/r-lib/httr2/issues/559)).

- [`url_modify()`](https://httr2.r-lib.org/reference/url_modify.md),
  [`url_modify_query()`](https://httr2.r-lib.org/reference/url_modify.md),
  and
  [`url_modify_relative()`](https://httr2.r-lib.org/reference/url_modify.md)
  modify URLs ([\#464](https://github.com/r-lib/httr2/issues/464));
  [`url_query_parse()`](https://httr2.r-lib.org/reference/url_query_parse.md)
  and
  [`url_query_build()`](https://httr2.r-lib.org/reference/url_query_parse.md)
...
- [`curl_translate()`](https://httr2.r-lib.org/reference/curl_translate.md)
  ...
  [`req_cookies_set()`](https://httr2.r-lib.org/reference/req_cookie_preserve.md)
...
- [`req_url_query()`](https://httr2.r-lib.org/reference/req_url.md) can
  control how spaces are encoded with `.space`
...
- [`url_parse()`](https://httr2.r-lib.org/reference/url_parse.md) parses
  relative URLs with new `base_url` argument
...
- New
  ...
  and
  [`oauth_flow_token_exchange()`](https://httr2.r-lib.org/reference/req_oauth_token_exchange.md)
...
- New
  [`oauth_cache_clear()`](https://httr2.r-lib.org/reference/oauth_cache_clear.md)
...
- [`req_body_file()`](https://httr2.r-lib.org/reference/req_body.md) now
  works with files \>64kb once more
...
- [`req_cache()`](https://httr2.r-lib.org/reference/req_cache.md) now
  re-caches the response if the body is hasn’t been modified but the
...
- [`req_perform()`](https://httr2.r-lib.org/reference/req_perform.md) no
  longer displays a progress bar when sleeping during tests. You can
...
- New
  ...
  [`req_perform_stream()`](https://httr2.r-lib.org/reference/req_perform_stream.md)
  it supports
  [`req_retry()`](https://httr2.r-lib.org/reference/req_retry.md) (with
  [@jcheng5](https://github.com/jcheng5),
  [\#519](https://github.com/r-lib/httr2/issues/519)).
- [`req_retry()`](https://httr2.r-lib.org/reference/req_retry.md) no
...
- [`resp_body_html()`](https://httr2.r-lib.org/reference/resp_body_raw.md)
  ...
  now work when
  [`req_perform()`](https://httr2.r-lib.org/reference/req_perform.md) is
  given a path ([\#448](https://github.com/r-lib/httr2/issues/448)).
...
- [`jwt_encode_hmac()`](https://httr2.r-lib.org/reference/jwt_claim.md)
...
- [`req_cache()`](https://httr2.r-lib.org/reference/req_cache.md) now
  prunes cache *before* checking if a given key exists, eliminating the
  occassional error about reading from an invalid RDS file. It also no
  longer tests for existence then later reads the cache, avoiding
...
- [`req_perform_parallel()`](https://httr2.r-lib.org/reference/req_perform_parallel.md)
  ...
  [`req_error()`](https://httr2.r-lib.org/reference/req_error.md).
...
- [`req_body_file()`](https://httr2.r-lib.org/reference/req_body.md) now
  only opens a connection when the request actually needs data. In
...
- [`req_perform_parallel()`](https://httr2.r-lib.org/reference/req_perform_parallel.md)
  ...
  [`req_cache()`](https://httr2.r-lib.org/reference/req_cache.md)
...
- [`req_perform_stream()`](https://httr2.r-lib.org/reference/req_perform_stream.md)
  ...
  [`last_request()`](https://httr2.r-lib.org/reference/last_response.md)
  and
  [`last_response()`](https://httr2.r-lib.org/reference/last_response.md)
  ([\#479](https://github.com/r-lib/httr2/issues/479)).
- [`req_url_query()`](https://httr2.r-lib.org/reference/req_url.md) now
  allows you to opt out of escaping for multi-value parameters
...
- [`req_retry()`](https://httr2.r-lib.org/reference/req_retry.md) gives
  a clearer error if `after` returns the wrong type of value
  ([\#385](https://github.com/r-lib/httr2/issues/385)).

- [`req_template()`](https://httr2.r-lib.org/reference/req_template.md)
  now works when you have a bare `:` in a template that uses “uri” style
  ([\#389](https://github.com/r-lib/httr2/issues/389)).

- [`req_timeout()`](https://httr2.r-lib.org/reference/req_timeout.md)
  now resets the value of `connecttimeout` set by curl. This ensures
  that you can use
  [`req_timeout()`](https://httr2.r-lib.org/reference/req_timeout.md) to
  increase the connection timeout past 10s
  ([\#395](https://github.com/r-lib/httr2/issues/395)).

- [`url_parse()`](https://httr2.r-lib.org/reference/url_parse.md) is
...
- `local_mock()` and `with_mock()` have been deprecated in favour of
  [`local_mocked_responses()`](https://httr2.r-lib.org/reference/with_mocked_responses.md)
  and
  [`with_mocked_responses()`](https://httr2.r-lib.org/reference/with_mocked_responses.md)
...
- [`oauth_flow_auth_code_listen()`](https://httr2.r-lib.org/reference/oauth_flow_auth_code_url.md)
...
- [`req_body_form()`](https://httr2.r-lib.org/reference/req_body.md) and
  [`req_body_multipart()`](https://httr2.r-lib.org/reference/req_body.md)
...
- A new family of functions
  [`resps_successes()`](https://httr2.r-lib.org/reference/resps_successes.md),
  [`resps_failures()`](https://httr2.r-lib.org/reference/resps_successes.md),
  [`resps_requests()`](https://httr2.r-lib.org/reference/resps_successes.md)
  and
  [`resps_data()`](https://httr2.r-lib.org/reference/resps_successes.md)
...
- New
  [`oauth_token_cached()`](https://httr2.r-lib.org/reference/oauth_token_cached.md)
...
- [`req_cache()`](https://httr2.r-lib.org/reference/req_cache.md) gains
  `max_n`, `max_size`, and `max_age` arguments to automatically prune
  the cache. By default, the cache will stay under 1 GB
...
- New
  [`req_cookie_preserve()`](https://httr2.r-lib.org/reference/req_cookie_preserve.md)
...
- New
  [`resp_check_content_type()`](https://httr2.r-lib.org/reference/resp_check_content_type.md)
...
- New
  [`resp_has_body()`](https://httr2.r-lib.org/reference/resp_body_raw.md)
  returns a `TRUE` or `FALSE` depending on whether or not the response
  has a body ([\#205](https://github.com/r-lib/httr2/issues/205)).

- New [`resp_url()`](https://httr2.r-lib.org/reference/resp_url.md),
  [`resp_url_path()`](https://httr2.r-lib.org/reference/resp_url.md),
  [`resp_url_queries()`](https://httr2.r-lib.org/reference/resp_url.md)
  and
  [`resp_url_query()`](https://httr2.r-lib.org/reference/resp_url.md) to
  extract various part of the response url
  ([\#57](https://github.com/r-lib/httr2/issues/57)).

- [`req_url_query()`](https://httr2.r-lib.org/reference/req_url.md)
...
- New
  [`secret_encrypt_file()`](https://httr2.r-lib.org/reference/secrets.md)
  and
  [`secret_decrypt_file()`](https://httr2.r-lib.org/reference/secrets.md)
...
- [`oauth_flow_refresh()`](https://httr2.r-lib.org/reference/req_oauth_refresh.md)
...
- [`obfuscated()`](https://httr2.r-lib.org/reference/obfuscate.md)
  values now display their original call when printed.

- [`req_body_json()`](https://httr2.r-lib.org/reference/req_body.md)
...
- [`req_cache()`](https://httr2.r-lib.org/reference/req_cache.md) now
  combine the headers of the new response with the headers of the cached
  response. In particular, this fixes `resp_body_json/xml/html()` on
  cached responses ([@mgirlich](https://github.com/mgirlich),
...
- [`req_perform()`](https://httr2.r-lib.org/reference/req_perform.md)’s
...
- New
  [`example_url()`](https://httr2.r-lib.org/reference/example_url.md) to
  launch a local server, making tests and examples more robust.

- New
  [`throttle_status()`](https://httr2.r-lib.org/reference/throttle_status.md)
...
- [`req_url_path()`](https://httr2.r-lib.org/reference/req_url.md) and
  [`req_url_path_append()`](https://httr2.r-lib.org/reference/req_url.md)
...
- `sys_sleep()` (used by
  [`req_retry()`](https://httr2.r-lib.org/reference/req_retry.md) and
  [`req_throttle()`](https://httr2.r-lib.org/reference/req_throttle.md))
...
- [`req_proxy()`](https://httr2.r-lib.org/reference/req_proxy.md) now
  uses the appropriate authentication option
  ([@jl5000](https://github.com/jl5000)).

- [`req_url_query()`](https://httr2.r-lib.org/reference/req_url.md) can
  now opt out of escaping with [`I()`](https://rdrr.io/r/base/AsIs.html)
...
- [`req_body_form()`](https://httr2.r-lib.org/reference/req_body.md),
  [`req_body_multipart()`](https://httr2.r-lib.org/reference/req_body.md),
  and [`req_url_query()`](https://httr2.r-lib.org/reference/req_url.md)
...
- [`req_body_json()`](https://httr2.r-lib.org/reference/req_body.md) now
  overrides the existing JSON body, rather than attempting to merge with
  the previous value ([\#95](https://github.com/r-lib/httr2/issues/95),
  [\#115](https://github.com/r-lib/httr2/issues/115)).

- Implement
  [`req_proxy()`](https://httr2.r-lib.org/reference/req_proxy.md)
...
- [`req_error()`](https://httr2.r-lib.org/reference/req_error.md) can
  now correct force successful HTTP statuses to fail
...
- [`response()`](https://httr2.r-lib.org/reference/response.md) now
