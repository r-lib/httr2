...
An HTTP [response](https://httr2.r-lib.org/dev/reference/response.md).
The body will be empty if the request was successful (since the
`callback` function will have handled it). The body will contain the
HTTP response body if the request was unsuccessful.
