...
#> accept-encoding: deflate, gzip, br, zstd
#> content-length: 246
#> content-type: multipart/form-data; boundary=------------------------szHQIYbi7DIYhjP2wqAtIH
#> host: 127.0.0.1:36423
#> user-agent: httr2/1.3.0.9000 r-curl/8.0.0 libcurl/8.5.0
#> 
#> --------------------------szHQIYbi7DIYhjP2wqAtIH
...
resp |> resp_raw()
#> HTTP/1.1 200 OK
#> Date: Tue, 08 Sep 2026 12:29:06 GMT
#> Content-Type: application/json
#> Content-Length: 407
#> ETag: "de760e6d"
#> 
