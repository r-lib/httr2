...
#> accept-encoding: deflate, gzip, br, zstd
#> content-length: 246
#> content-type: multipart/form-data; boundary=------------------------nteCMvPb0u3XbnOlUojyUB
#> host: 127.0.0.1:34715
#> user-agent: httr2/1.3.0.9000 r-curl/8.0.0 libcurl/8.5.0
#> 
#> --------------------------nteCMvPb0u3XbnOlUojyUB
...
resp |> resp_raw()
#> HTTP/1.1 200 OK
#> Date: Thu, 27 Aug 2026 18:04:09 GMT
#> Content-Type: application/json
#> Content-Length: 407
#> ETag: "de760e6d"
#> 
